import"../modulepreload-polyfill-3cfb730f.js";import{l}from"../viewpartials-ac66bf27.js";import{b as i}from"../config-d2c69cb0.js";async function d(){try{const s={method:"GET",headers:new Headers,redirect:"follow"};return await(await fetch(i+"/portada/",s)).json()}catch(o){console.log("error",o)}}(async function(){let o=[{path:"../partials/tienda/header.html",container:"header"},{path:"../partials/tienda/footer.html",container:"footer"}];try{await l(o),console.log("Las vistas parciales se han cargado correctamente!"),n()}catch(s){console.error(s)}})();function n(){c()}async function c(){let o=await d();p(o.sliders),h(o.categorias),u(o.productosOferta),C(o.productosDestacados),f(o.productosRecientes)}function p(o){let s=`
