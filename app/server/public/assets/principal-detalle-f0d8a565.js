import"./modulepreload-polyfill-3cfb730f.js";import{a as E}from"./index-339297ac.js";import{b as l,g as k}from"./config-d2c69cb0.js";import"./preload-helper-101896b7.js";import"./init-b7ef0f37.js";import"./toast-8abe4fe9.js";import"./viewpartials-ac66bf27.js";async function T(s){try{return await(await fetch(`${l}/producto/${s}`,{method:"GET"})).json()}catch(e){console.error("Error:",e)}}async function I(s){try{return await(await fetch(`${l}/artesano/${s}`,{method:"GET"})).json()}catch(e){console.error("Error:",e)}}async function C(s){try{const o=await(await fetch(`${l}/v1/productos/categoria/${s}`,{method:"GET"})).json();return console.log("productos: ",o),o}catch(e){console.error("Error:",e)}}function O(){return k("idCliente")}document.querySelector(".add-to-wishlist a").addEventListener("click",s=>{s.preventDefault();const e=y("id"),o=O();console.log(`Adding product ${e} to wishlist for client ${o}`),E(e,o)});document.addEventListener("DOMContentLoaded",async()=>{N(),L()});async function N(){const s=y("id"),e=await T(s),o=await I(e.artesano_id);let S={101:"TE",108:"CER",113:"PT",131:"RET",132:"OH"}[e.categoria_id]||e.categoria_id.toString(),c=(await C(S)).data.filter(t=>t.id!==parseInt(s)),d="";for(let t=0;t<c.length;t++){let r=c[t];d+=`
