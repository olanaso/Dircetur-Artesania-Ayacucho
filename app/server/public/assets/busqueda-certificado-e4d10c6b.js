import"./modulepreload-polyfill-3cfb730f.js";import{v as d}from"./validateForm-1578b31b.js";import{b as a}from"./config-d2c69cb0.js";async function i(t){const s={method:"GET",redirect:"follow"};try{return await(await fetch(a+`/api/search?search=${encodeURIComponent(t)}`,s)).json()}catch(r){throw console.error("Error al buscar los certificados:",r),r}}l();let o=`
