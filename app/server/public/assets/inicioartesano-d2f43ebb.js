import"./modulepreload-polyfill-3cfb730f.js";import{_ as O}from"./preload-helper-101896b7.js";import{l as C}from"./viewpartials-ac66bf27.js";import{h as I,l as P,c as B}from"./init-b7ef0f37.js";import{b as p}from"./config-d2c69cb0.js";async function z(o){try{const t={method:"GET",headers:new Headers,redirect:"follow"};return await(await fetch(p+"/reporte1/"+o,t)).json()}catch(s){console.log("error",s)}}async function A(o){try{const t={method:"GET",headers:new Headers,redirect:"follow"};return await(await fetch(p+"/productoartesanos/"+o,t)).json()}catch(s){console.log("error",s)}}async function S(o){try{const t={method:"GET",headers:new Headers,redirect:"follow"};return await(await fetch(p+"/reporte2/"+o,t)).json()}catch(s){console.log("error",s)}}async function j(o){try{const t={method:"GET",headers:new Headers,redirect:"follow"};return await(await fetch(p+"/pedidodetalle/"+o,t)).json()}catch(s){console.log("error",s)}}I();(async function(){let o=[{path:"partials/shared/header.html",container:"app-header"},{path:"partials/shared/menu.html",container:"app-side"}];try{await C(o),O(()=>import("./common-8d3221b9.js"),[]),console.log("Las vistas parciales se han cargado correctamente!"),q()}catch(s){console.error(s)}})();function q(){G(),setTimeout(function(){P()},500)}var c=null,w=null,_=null,k=null;let d=null;async function G(){let o=await B();if(console.log(o),o.isvalid){d=o.usuarios,L(d.datos[0].id);const s=document.getElementById("id_nombre");s.innerText=d.nombre_completo;const t=document.getElementById("id_rol");t.innerText=d.rol.denominacion}else location.href="sinacceso.html"}async function L(o){c=await z(o);const s=document.getElementById("id_total");s.innerText=c[0].pagado;const t=document.getElementById("id_entregado");t.innerText=c[0].envio;const l=document.getElementById("id_pendiente");l.innerText=c[0].pendiente;const i=document.getElementById("id_proceso");i.innerText=c[0].proceso,w=await A(o);let a="";for(let e of w)a+=`
