import"./modulepreload-polyfill-3cfb730f.js";import{g as m}from"./config-d2c69cb0.js";import{l as u,u as h,d as b,a as y}from"./index-339297ac.js";import{A as w}from"./alert-3bd678b2.js";import{s as p}from"./toast-8abe4fe9.js";import{s as g,h as v}from"./init-b7ef0f37.js";import"./login-cliente-885bfb3e.js";import"./preload-helper-101896b7.js";import"./viewpartials-ac66bf27.js";const L=new w;$(document).ready(function(){f()});let n=[],r=1;const c=3;async function f(){try{g();const e=m("idCliente"),t=await u(e);console.log(t),n=t.data,l(),P(),h(n.length)}catch(e){console.error(e)}finally{v()}}function l(){const e=document.querySelector(".product-list");if(e.innerHTML="",n.length===0){const t=document.querySelector(".title"),o=document.querySelector("hr");t.style.display="none",o.style.display="none",e.innerHTML=`
