    ...
    d.prototype = {
        ...
        _createSlide: function(a, d) {
            ...
            g.on("imagesLoaded." + c, function(a) {
                f.settings.autoSlideSize === !0 && (f.$slides.hasClass("sp-animated") === !1 && f._resetSlidesPosition(),
        ...
        _updateSlidesPosition: function() {
            var a, b, c, d, e, f = parseInt(this.$slides.find(".sp-slide").eq(this.selectedSlideIndex).css(this.positionProperty), 10), g = f;
            if (this.settings.autoSlideSize === !0)
                ...
                for (d = this.settings.rightToLeft === !0 && "horizontal" === this.settings.orientation ? -1 : 1,
                e = "horizontal" === this.settings.orientation ? this.slideWidth : this.slideHeight,
                c = 0; c < this.slidesOrder.length; c++)
        ...
        _resetSlidesPosition: function() {
            ...
            if (this.settings.autoSlideSize === !0) {
                ...
                for (e = (this.settings.rightToLeft === !0 && "horizontal" === this.settings.orientation) == !0 ? -1 : 1,
                f = "horizontal" === this.settings.orientation ? this.slideWidth : this.slideHeight,
                c = 0; c < this.slidesOrder.length; c++)
                    b = this.$slides.find(".sp-slide").eq(this.slidesOrder[c]),
        ...
        _calculateSlidesSize: function() {
            if (this.settings.autoSlideSize === !0) {
                ...
                this.slidesSize = (("horizontal" === this.settings.orientation ? this.slideWidth : this.slideHeight) + this.settings.slideDistance) * this.slides.length - this.settings.slideDistance,
...
function(a, b) {
    ...
    var c = "Retina." + b.SliderPro.namespace
      , d = {
        initRetina: function() {
            this._isRetina() !== !1 && (this.on("sliderResize." + c, b.proxy(this._checkRetinaImages, this)),
    ...
    var c = "TouchSwipe." + b.SliderPro.namespace
      , d = {
        ...
        _onTouchStart: function(a) {
            ...
            if (this.previousStartEvent = a.type,
        ...
        _onTouchMove: function(a) {
            ...
            this.allowOppositeScrolling !== !0 && (a.preventDefault(),
        ...
        _onTouchEnd: function(a) {
            ...
            this.$slider.hasClass("sp-swiping") && setTimeout(function() {
    ...
    var c = "ThumbnailTouchSwipe." + b.SliderPro.namespace
      , d = {
        ...
        _onThumbnailTouchStart: function(a) {
            if ("mousedown" === a.type && "touchstart" === this.thumbnailPreviousStartEvent)
                return void (this.thumbnailPreviousStartEvent = a.type);
            if (this.thumbnailPreviousStartEvent = a.type,
            !(b(a.target).closest(".sp-selectable").length >= 1)) {
      ...
      , d = {
        ...
        _initVideo: function(a) {
            ...
            a.on("videoPause." + c, function() {
                "startAutoplay" === d.settings.pauseVideoAction && "undefined" != typeof d.startAutoplay && (d.stopAutoplay(),
                d.startAutoplay(),
            ...
            a.on("videoEnded." + c, function() {
                "startAutoplay" === d.settings.endVideoAction && "undefined" != typeof d.startAutoplay ? (d.stopAutoplay(),
                d.startAutoplay(),
        ...
        _videoOnGotoSlide: function(a) {
            ...
            -1 !== a.previousIndex && 0 !== b.length && ("stopVideo" === this.settings.leaveVideoAction ? b.videoController("stop") : "pauseVideo" === this.settings.leaveVideoAction ? b.videoController("pause") : "removeVideo" === this.settings.leaveVideoAction && (0 !== b.siblings("a.sp-video").length ? (b.siblings("a.sp-video").css("display", ""),
        ...
        _videoOnGotoSlideComplete: function(a) {
            if ("playVideo" === this.settings.reachVideoAction && a.index === this.selectedSlideIndex) {
                ...
                0 === b.length && 0 === d.length || "stopAutoplay" !== this.settings.playVideoAction || "undefined" == typeof this.stopAutoplay || (this.stopAutoplay(),
      ...
      , h = function(b) {
        ...
        g.vimeoAPIAdded === !1) {
            ...
            var f = setInterval(function() {
                "undefined" != typeof window.Vimeo && (clearInterval(f),
