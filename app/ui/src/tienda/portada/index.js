...
function loadProductosOferta (data) {
  ...
  <button type="button" class="btn-buttons btn-light"><a class="" href="producto.html?producto=${encodeURIComponent(JSON.stringify(artenia_deseados))}">Ver más</a></button>
  <button type="button" class="btn-buttons btn-light btn-comprar" producto_id="${item.id}">
  <svg
  ...
  <button type="button" class="btn-buttons btn-light btn-favoritos" producto_id="${item.id}">	<svg width="15" height="14" viewBox="0 0 15 14" fill="none"
												xmlns="http://www.w3.org/2000/svg">
												<path
