            ...
            <div class="car-item wow fadeIn" data-wow-duration="0.75s">
                ...
                <div class="down-content text-center">
                    ...
                    <p class="text-danger font-weight-bold">
                        <span class="d-block d-md-none h5">S/.${formatearNumero(item?.precio) || ''}</span>
                        <span class="d-none d-md-block h4">S/.${formatearNumero(item?.precio) || ''}</span>
                    </p>
                    <p class="card-text text-muted">
                        <span class="d-block d-md-none" style="font-size: 0.85rem;">Categoría: ${item?.categoria || ''}</span>
                        <span class="d-none d-md-block" style="font-size: 1rem;">Categoría: ${item?.categoria || ''}</span>
                    </p>
                    <div class="d-flex align-items-center mt-3" title="Artesano">
                        ...
                        <span class="text-dark">
                            <a style="color: #dedede!important;" 
