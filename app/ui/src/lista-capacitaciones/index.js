...
async function exportarExcel () {
  ...
  $('#btnDescargar').on('click', async function (e) {

    createXLS(certificados, 'Consolidado-Certificados');
  })
...
async function buscarUsuario () {
  ...
  $('#btnbuscar').on('click', async function (e) {
    ...
    e.preventDefault();
    let dni = $('#searchBox').val()
    if (dni) {
      showLoading()
      //let certificados = buscarCertificados($('#searchBox').val())
      //console.log(certificados) 
      // Obtener la lista de certificados
      certificados = await buscarCertificados($('#searchBox').val());
      ...
      showToast('Ingrese código de certificado o el Nombre del estudiante')
    }
