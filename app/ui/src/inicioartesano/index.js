...
import perfilVaron from './img/perfil_varon.svg';
...
async function validarSession () {
  ...
  if (result.isvalid) {
    ...
    $('#img_artesano').attr('src', datosArtesano.foto1 || datosArtesano.foto2).on('error', function () {
    ...
    $('#id_nombre').text(datosArtesano.nombres + ' ' + datosArtesano.apellidos)
